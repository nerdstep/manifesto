 ...
 *
 * Sharing it rather than copying it matters more here than it looks. The previews choose
 * readable text by WCAG contrast, while the pipeline decides whether an Icon Background
 * is dark enough to warrant the Dark Mark. Those are different decisions, but they must
 * use the same luminance and gamma maths or the UI and generated bytes stop agreeing about
 * the colour beneath them.
 */
